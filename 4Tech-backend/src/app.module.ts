...
import {  UserRepositorie } from './repositories/user-repositorie/user-repositorie';
...
import { UserActivitySchema } from './domain/schema/user-activity.schema';
...
import { UserActivityRepository } from './repositories/user-repositorie/user-activity-repository/user-activity.repository';
...
@Module({
  ...
  providers: [AppService,UserService, UserRepositorie, AuthService, JwtStrategy, UserActivityService, UserActivityRepository, WebsocketGateway],
})
